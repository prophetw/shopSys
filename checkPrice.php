...
<form action="showPrice.php" method="post">
    <label for="price">仅显示批发价零售价</label><input type="radio" name="choose" id="price" value="justPrice" checked="checked" />
    <label for="allinfo">显示商品所有信息</label><input type="radio" name="choose" id="allinfo" value="showAll" />
    <br/>
    <input type="text" name="productinfo" id="serchinfo" placeholder="商品名、型号、条形码"/>
    <br/>
