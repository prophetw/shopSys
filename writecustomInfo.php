...
<body>
<h1>客户商家信息录入</h1>
<form action="writecustomInfo.php" method="post">
    <span>客户／商家姓名</span><span>电话</span><span>地区</span><span>店名／地址</span>
    <div class="data" id="original">
        <input type="text" name="name[]"/>
        <input type="text" name="phone[]"/>
        <input type="text" name="area[]" placeholder="如:晓天、三沟"/>
        <input type="text" name="address[]" placeholder="常送货地点"/>
...
for($count=0;$count<count($name);$count++) {
    ...
    $query = "INSERT INTO custominfo (name,phone,aera,address) VALUES  ('$name[$count]','$phone[$count]','$area[$count]','$address[$count]')";
    //echo $query;
